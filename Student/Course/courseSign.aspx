...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container mt-5">
        ...
        <div class="form-group">
            <asp:Button ID="Button1" runat="server" OnClick="Leader_Click" Text="Grup Lideri Ol" CssClass="btn btn-primary" />
            <asp:Button ID="Button2" runat="server" OnClick="Member_Click" Text="Gruba Katıl" CssClass="btn btn-primary" />
            <asp:Button ID="Button3" runat="server" OnClick="btnManageRequests_Click" Text="Gruba Katılım İsteklerini Yönet" CssClass="btn btn-secondary" />
            <asp:Button ID="Button4" runat="server" OnClick="btnSendTeacherRequest_Click" Text="Öğretmene Katılma İsteği Gönder" CssClass="btn btn-info" />
        </div>
    </div>
</asp:Content>--%>
